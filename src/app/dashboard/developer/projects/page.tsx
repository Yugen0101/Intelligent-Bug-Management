...
import { FolderKanban, ExternalLink, Bug, Clock } from 'lucide-react'
        ...
        <DashboardLayout role="developer">
            <div className="space-y-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Assigned Projects</h1>
                        <p className="text-gray-500 font-medium">View projects where you have active bug assignments.</p>
                    </div>
                </div>
