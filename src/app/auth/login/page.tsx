                ...
                <div className="bg-white rounded-[3rem] p-10 md:p-12 border border-gray-200 shadow-2xl shadow-gray-200/50">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-5 bg-gray-900 text-white font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-black transition-all shadow-xl shadow-gray-200 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed mt-4 group overflow-hidden relative"
                        >
                    ...
                    <p className="mt-10 text-center text-sm font-medium text-gray-500">
                        New user?{' '}
                        <Link href="/auth/signup" className="text-blue-600 hover:text-blue-700 transition-colors font-black uppercase tracking-widest text-[10px]">
                            Create Account
                        </Link>
                    </p>
                </div>
