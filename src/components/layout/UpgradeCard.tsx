...
export function UpgradeCard() {
    return (
        <div className="p-4 rounded-3xl bg-blue-600 relative overflow-hidden group shadow-lg shadow-blue-200">
            {/* Background elements */}
            ...
            <div className="relative z-10 flex flex-col gap-3">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-blue-100 text-[10px] leading-relaxed opacity-90">
                        Upgrade your account and unlock all of the benefits.
                    </p>
                </div>

                <button className="w-full py-2.5 bg-white text-blue-600 rounded-xl text-[11px] font-black uppercase tracking-wider hover:bg-blue-50 transition-all active:scale-95 shadow-sm">
                    Upgrade premium
                </button>
            </div>
        </div>
