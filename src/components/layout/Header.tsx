        ...
        <header className="h-16 bg-white/60 backdrop-blur-md border-b border-gray-100/50 flex items-center justify-between px-6 md:px-8 sticky top-0 z-20">
            <div className="flex items-center gap-6 flex-1">
                ...
                <div className="relative w-full max-w-sm hidden md:block group">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-12 py-2 bg-[#f9fafb] border border-gray-100 rounded-xl text-[13px] text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600/5 focus:border-blue-600/20 transition-all font-medium"
                    />
            ...
            <div className="flex items-center gap-3 md:gap-5">
                <div className="flex items-center gap-1">
                    <button className="p-2 text-gray-400 hover:text-blue-600 transition-all rounded-lg hover:bg-gray-50">
                ...
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full border-2 border-white shadow-sm overflow-hidden bg-gray-50 flex items-center justify-center cursor-pointer hover:ring-2 hover:ring-blue-50 transition-all group">
                        {profile?.avatar_url ? (
